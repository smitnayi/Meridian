    ...
    <div className="page-content" style={{ minHeight: '100vh', padding: '24px' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 28 }}>
        ...
        <div style={{ display: 'flex', gap: 10 }}>
          {/* Category Filter */}
          <div style={{ display: 'flex', gap: 2, background: 'rgba(255,255,255,0.8)', borderRadius: 11, padding: 4, border: '1px solid rgba(226,232,240,0.8)' }}>
            ...
            {['month', 'week', 'day'].map((v) => (
              <button
                ...
                style={{
                  ...
                  fontWeight: view === v ? 600 : 400, cursor: 'pointer', textTransform: 'capitalize',
                }}
              >
                {v}
              </button>
          ...
          <button
            ...
            style={{
              display: 'flex', alignItems: 'center', gap: 6, padding: '8px 16px', borderRadius: 11, border: 'none',
              background: 'linear-gradient(135deg, #6366f1, #818cf8)', color: 'white',
      ...
      <div className="glass" style={{ borderRadius: 20, overflow: 'hidden', padding: 0 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '18px 24px', borderBottom: '1px solid rgba(226,232,240,0.5)' }}>
          <button
            ...
            style={{ width: 32, height: 32, borderRadius: 8, border: '1px solid rgba(226,232,240,0.8)', background: 'rgba(255,255,255,0.8)', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#64748b' }}
          >
        ...
        {/* Day Headers */}
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', borderBottom: '1px solid rgba(226,232,240,0.5)' }}>
          {days.map((d) => (
            <div key={d} style={{ padding: '10px 16px', fontSize: 11.5, fontWeight: 600, color: '#94a3b8', letterSpacing: '0.06em', textAlign: 'center' }}>{d.toUpperCase()}</div>
          ))}
        </div>
